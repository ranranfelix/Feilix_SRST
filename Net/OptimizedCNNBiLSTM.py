...
class OptimizedCNNBiLSTM(nn.Module):
    ...
    def __init__(self, in_channels=1, out_channels=11, depth=2, seq_len=3, 
        ...
        print("✓ OptimizedCNNBiLSTM初始化完成")
        print(f"  - LSTM后dropout: p=0.08")
        print(f"  - 融合后dropout: p=0.10")
        print(f"  - 输出前dropout: p=0.05")
    ...
    def forward(self, x, hidden_state=None):
        ...
        if first_half_len > 0:
            ...
            o1 = torch.zeros(o1_shape, device=device)
        ...
        if latter_half_len > 0:
            ...
            o2 = torch.zeros(o2_shape, device=device)
